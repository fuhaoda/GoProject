...
//checked by Haoda
//Returns the number of liberties a new stone placed here would have, or max if it would be >= max. It also predict 0 liberty move into a suicide position.
...
//checked by Haoda (very good design)
...
//checked by Haoda todo: can be more tight by using loop
...
//checked by Haoda (very good code)
